...
id_token = response_login.json()['idToken']

data = {
    "data": {"all": "false", "date": "2021-12-31T23:00:00.000Z", "endData": "2022-12-31T23:00:00.000Z", "type": "csv"}}

response_export = requests.post('https://us-central1-diabtrend-db.cloudfunctions.net/exportToCsv', json=data,
